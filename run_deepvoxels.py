...
def train():
    ...
    train_dataset = NovelViewTriplets(root_dir=opt.data_root,
                                      ...
                                      sampling_pattern=opt.sampling_pattern) # two target views, one source view
    # print("######shape for train_dataset #####:",train_dataset)

    # print("######shape for train_dataset #####:",train_dataset.shape)
    dataloader = DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=8)


      
    # print("######shape for dataloader #####:",len(dataloader))
    ...
    for epoch in range(opt.start_epoch, opt.max_epoch):
        for trgt_views, nearest_view in dataloader:
            # print("########",len(trgt_views))
            # print("########",len(nearest_view)) ### ???? 
